...
void initializeSolarZones(){
    ...
    */
    ...
    solarZones[1].targetPositionLowY = solarZones[1].posY - solarOffsetB - 0.03;
    solarZones[1].targetPositionUpX = solarZones[1].posX;
    solarZones[1].targetPositionUpY = solarZones[1].posY + solarOffsetB + 0.03;

    solarZones[2].zoneID = 2;
    solarZones[2].posX = 1.805;
    ...
    solarZones[2].targetPositionLowY = solarZones[2].posY - solarOffsetB - 0.02;
