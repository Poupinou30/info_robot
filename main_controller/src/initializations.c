...
void initializeEndZones(){
    ...
    */
    ...
    // orientation du robot pour finir dans cette zone = 90
    ...
    // orientation du robot pour finir dans cette zone = 270 
    ...
    // orientation du robot pour drop dans cette zone = 0
    ...
    // orientation du robot pour finir dans cette zone = 0
