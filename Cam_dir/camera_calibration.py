...
calib_imgs_path = root.joinpath("Cam_dir", "calib.jpg")
calib_imgs_path = Path("/home/student/Documents/lab_git_augu/info_robot")

# For validating results, show aruco board to camera.
aruco_dict = aruco.getPredefinedDictionary( aruco.DICT_6X6_1000 )

#Provide length of the marker's side
markerLength = 3.00 # Here, measurement unit is centimetre.

# Provide separation between markers
markerSeparation = 0.4   # Here, measurement unit is centimetre.

# create arUco board
board = aruco.GridBoard_create(5, 4, markerLength, markerSeparation, aruco_dict)
...
if calibrate_camera == True:
    ...
    for im in tqdm(img_list):
        ...
        cv2.imshow("img_gray test", img_gray)
